...
func (m *MockLibvirt) handleRemote(procedure libvirt.RemoteProcedure, conn net.Conn) {
	switch procedure {
	case libvirt.RemoteProcAuthList:
		conn.Write(m.reply(testAuthReply))
	case libvirt.RemoteProcStoragePoolRefresh:
		conn.Write(m.reply(testStoragePoolRefresh))
	case libvirt.RemoteProcStoragePoolLookupByName:
		conn.Write(m.reply(testStoragePoolLookup))
	case libvirt.RemoteProcConnectOpen:
		conn.Write(m.reply(testConnectReply))
	case libvirt.RemoteProcConnectClose:
		conn.Write(m.reply(testDisconnectReply))
	case libvirt.RemoteProcConnectGetLibVersion:
		conn.Write(m.reply(testVersionReply))
	case libvirt.RemoteProcDomainLookupByName:
		conn.Write(m.reply(testDomainResponse))
	case libvirt.RemoteProcConnectListAllDomains:
		conn.Write(m.reply(testDomainsReply))
	case libvirt.RemoteProcConnectListAllStoragePools:
		conn.Write(m.reply(testListPoolsReply))
	case libvirt.RemoteProcConnectListAllSecrets:
		conn.Write(m.reply(testSecretsReply))
	case libvirt.RemoteProcDomainGetState:
		conn.Write(m.reply(testDomainStateReply))
	case libvirt.RemoteProcDomainMigrateSetMaxSpeed:
		conn.Write(m.reply(testSetSpeedReply))
	case libvirt.RemoteProcDomainMigratePerform3Params:
		conn.Write(m.reply(testMigrateReply))
	case libvirt.RemoteProcDomainUndefineFlags:
		conn.Write(m.reply(testUndefineReply))
	case libvirt.RemoteProcDomainDestroyFlags:
		conn.Write(m.reply(testDestroyReply))
	case libvirt.RemoteProcDomainDefineXmlFlags:
